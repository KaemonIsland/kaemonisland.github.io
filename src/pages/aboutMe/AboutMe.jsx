...
export const AboutMe = () => (
  <div className={styles.wrap}>
    <GridItem type="text">
      ...
      <p>
        Hello, I&apos;m Kaemon, a<strong>Self Taught</strong>
        developer from Salt Lake City, UT! I&apos;m known to approach every
        situation with an almost scary amount of optimism! Only because I am
        excited to learn something new. (even if I fail)
        <br />
        <br />
        When I&apos;m not coding, you can find me playing video games with my
        wife, and spending time with my children.
      </p>
    </GridItem>
